...
export class Face {
    ...
    */
    'imageUrl'?: string;
    'detectedEntity'?: FaceDetectedEntity;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "sourceExtraction",
            "type": "string"
        },
        {
            "name": "frameInSource",
            "baseName": "frameInSource",
            "type": "number"
        },
        {
            "name": "bbox",
        ...
        {
            "name": "detectedEntity",
            "baseName": "detectedEntity",
            "type": "FaceDetectedEntity"
        }    ];

    static getAttributeTypeMap() {
        return Face.attributeTypeMap;
    }
}
