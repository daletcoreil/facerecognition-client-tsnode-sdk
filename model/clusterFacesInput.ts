...
*/
export class ClusterFacesInput extends JobInput {
    /**
    * ID of a FaceCollection produced by an ExtractFaces job
    */
    'faceExtractionId': string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "faceExtractionId",
            "baseName": "faceExtractionId",
            "type": "string"
        },
        {
            "name": "clusterCollectionId",
            "baseName": "clusterCollectionId",
            "type": "string"
        },
        {
            "name": "minimumClusterSize",
            "baseName": "minimumClusterSize",
            "type": "number"
        },
        {
            "name": "similarityThreshold",
            "baseName": "similarityThreshold",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ClusterFacesInput.attributeTypeMap);
    }
}
