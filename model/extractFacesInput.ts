...
*/
export class ExtractFacesInput extends JobInput {
    /**
    ...
    */
    'effort'?: ExtractFacesInput.EffortEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "effort",
            "baseName": "effort",
            "type": "ExtractFacesInput.EffortEnum"
        },
        {
            "name": "minimumFacesize",
            "baseName": "minimumFacesize",
            "type": "number"
        },
        {
            "name": "faceSize",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ExtractFacesInput.attributeTypeMap);
    }
}

export namespace ExtractFacesInput {
