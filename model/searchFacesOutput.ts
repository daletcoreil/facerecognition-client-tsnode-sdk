...
export class SearchFacesOutput extends JobOutput {
    'searchResult'?: Array<SearchFacesOutputItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<SearchFacesOutputItem>"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SearchFacesOutput.attributeTypeMap);
    }
}
