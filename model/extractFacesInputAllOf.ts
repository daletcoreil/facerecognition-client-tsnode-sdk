...
export class ExtractFacesInputAllOf {
    /**
    ...
    */
    'effort'?: ExtractFacesInputAllOf.EffortEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "effort",
            "baseName": "effort",
            "type": "ExtractFacesInputAllOf.EffortEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return ExtractFacesInputAllOf.attributeTypeMap;
    }
}

export namespace ExtractFacesInputAllOf {
