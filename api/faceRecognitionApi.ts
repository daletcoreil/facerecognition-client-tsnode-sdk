...
import { ClusterCollection } from '../model/clusterCollection';
import { Face } from '../model/face';
import { FaceExtractionCollection } from '../model/faceExtractionCollection';
...
export enum FaceRecognitionApiApiKeys {
    tokenSignature,
}
...
export class FaceRecognitionApi {
    ...
    public setApiKey(key: FaceRecognitionApiApiKeys, value: string) {
        (this.authentications as any)[FaceRecognitionApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param projectServiceId Project service id of the client associated to the request
     * @param uid Cluster Collection Id
     */
    public async getClusterCollection (projectServiceId: string, uid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ClusterCollection;  }> {
        const localVarPath = this.basePath + '/face-recognition/cluster-collection/{uid}'
        ...
        if (projectServiceId === null || projectServiceId === undefined) {
            throw new Error('Required parameter projectServiceId was null or undefined when calling getClusterCollection.');
        }

        // verify required parameter 'uid' is not null or undefined
        if (uid === null || uid === undefined) {
            throw new Error('Required parameter uid was null or undefined when calling getClusterCollection.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ClusterCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ClusterCollection");
     ...
     * @param uid Face Id
     */
    public async getFace (projectServiceId: string, uid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Face;  }> {
        const localVarPath = this.basePath + '/face-recognition/face/{uid}'
            .replace('{' + 'uid' + '}', encodeURIComponent(String(uid)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'projectServiceId' is not null or undefined
        if (projectServiceId === null || projectServiceId === undefined) {
            throw new Error('Required parameter projectServiceId was null or undefined when calling getFace.');
        }

        // verify required parameter 'uid' is not null or undefined
        if (uid === null || uid === undefined) {
            throw new Error('Required parameter uid was null or undefined when calling getFace.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: Face;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Face");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param projectServiceId Project service id of the client associated to the request
     * @param uid Face Collection Extraction Id
     */
    public async getFaceExtractionCollection (projectServiceId: string, uid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: FaceExtractionCollection;  }> {
        const localVarPath = this.basePath + '/face-recognition/face-extraction-collection/{uid}'
            .replace('{' + 'uid' + '}', encodeURIComponent(String(uid)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'projectServiceId' is not null or undefined
        if (projectServiceId === null || projectServiceId === undefined) {
            throw new Error('Required parameter projectServiceId was null or undefined when calling getFaceExtractionCollection.');
        }

        // verify required parameter 'uid' is not null or undefined
        if (uid === null || uid === undefined) {
            throw new Error('Required parameter uid was null or undefined when calling getFaceExtractionCollection.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: FaceExtractionCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FaceExtractionCollection");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
